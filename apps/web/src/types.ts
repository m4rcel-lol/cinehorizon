...
export interface DownloadItem { id: string; category: DownloadCategory; title: string; slug: string; description: string; platform: Platform; version?: string | null; developer?: string | null; genre?: string | null; coverImageUrl: string; fileName: string; fileSize: number; downloadCount: number; isPublished: boolean; createdAt: string }
