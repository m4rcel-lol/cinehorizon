...
export type GamePlatform = 'WINDOWS' | 'MAC' | 'LINUX' | 'ANDROID' | 'MULTI';
export interface Game { id: string; title: string; slug: string; description: string; platform: GamePlatform; version?: string | null; developer?: string | null; genre?: string | null; coverImageUrl: string; fileName: string; fileSize: number; downloadCount: number; isPublished: boolean; createdAt: string }
