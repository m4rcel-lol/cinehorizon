...
export async function resolveFfmpeg() {
    ...
    if (!ffmpegPath)
        throw new AppError(500, 'FFMPEG_NOT_FOUND', 'ffmpeg binary was not found');
    return ffmpegPath;
}
export function buildFfmpegArgs(input, outputDir) {
    return [
        '-y', '-i', input,
...
export async function transcodeToHls(input, outputDir) {
