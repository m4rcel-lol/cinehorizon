...
export function buildFfmpegArgs(input: string, outputDir: string) {
  ...
  return [
    ...
    '-map', '[v480]', '-map', '0:a:0?', '-c:v:0', 'libx264', '-crf:v:0', '23', '-preset', 'fast', '-b:v:0', '800k', '-maxrate:v:0', '856k', '-bufsize:v:0', '1200k', '-c:a:0', 'aac', '-b:a:0', '96k',
    '-map', '[v720]', '-map', '0:a:0?', '-c:v:1', 'libx264', '-crf:v:1', '22', '-preset', 'fast', '-b:v:1', '2800k', '-maxrate:v:1', '2996k', '-bufsize:v:1', '4200k', '-c:a:1', 'aac', '-b:a:1', '128k',
    '-map', '[v1080]', '-map', '0:a:0?', '-c:v:2', 'libx264', '-crf:v:2', '21', '-preset', 'fast', '-b:v:2', '5000k', '-maxrate:v:2', '5350k', '-bufsize:v:2', '7500k', '-c:a:2', 'aac', '-b:a:2', '192k',
